...
const Profile: FC = () => {
  const {replace, navigate} = useTypedNavigation();
  const {removeToken} = useAuthTokenStore();
  ...
  return (
    <Layout className={'bg-matule-blue'}>
      ...
      <TouchableOpacity
        onPress={() => navigate('OrderHistoryPage')}
        className={'flex-row items-center my-3'}>
